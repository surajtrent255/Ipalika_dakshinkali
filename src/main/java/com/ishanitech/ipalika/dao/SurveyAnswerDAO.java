...
public interface SurveyAnswerDAO {
	 ...
	 * @return
	 */
	@SqlQuery("SELECT id as id, filled_id as filledId, answer_1 AS houseOwner, answer_2 AS tole, answer_3 as ward, answer_4 AS houseNo, answer_5 AS phoneNo, answer_13 AS kittaNo, answer_51 as imageUrl, " +
